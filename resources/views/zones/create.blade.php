...
<div class="form-container">
    <h2><i class="fas fa-map-marker-alt"></i> Nouvelle zone</h2>
    ...
    <form method="POST" action="{{ route('zones.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nom_zone" value="{{ old('nom_zone') }}" placeholder="Nom de la zone" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="marche_id" required>
                ...
                @foreach($marches as $marche)
                    <option value="{{ $marche->id }}">{{ $marche->nom }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="description" rows="4" placeholder="Description de la zone">{{ old('description') }}</textarea>
        </div>
